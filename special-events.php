...
<head>
  ...
  <title>Special Events Live Video | Emanuel Evangelical Lutheran Church</title>
  ...
  <div class="container layout-v2">
    ...
    <div class="row main-content inner-page-content">
      <div class="col-xs-12 col-sm-8">
        <h1 class="page-title">Special Events Live Video</h1>
        <div class="row">
          <div class="col-xs-12">
            <div class="fluid-width-video-wrapper">
              ...
              <?php /* Emanual 2026 Talent Show */ ?>
              <iframe class="video-iframe" src="https://www.youtube-nocookie.com/embed/Pq-9lqu2rf0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </div>
