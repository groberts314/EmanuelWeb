              ...
              <ul class="event-list">
                <li class="event-date-entry">
                  ...
                  <div class="event-details">
                     ...
                     <div class="event-detail">
                       <div class="event-description">
                         <a href="event-fliers/2019-03-30-women-interfaith-v2.jpg" target="_blank">
                  ...
                  <div class="event-details">
                     <div class="event-detail">
                       <div class="event-description">
                         ...
                         <br />
                         Procession with Palms at 9 and 10:45 AM worship services.
                       </div>
                  ...
                  <div class="event-details">
                    <div class="event-detail">
                      <div class="event-description">
                        ...
                        <br />
                        The Resurrection of our Lord!  ALLELUIA!
                      </div>
                    </div>
                     <div class="event-detail">
                       <div class="event-description">
                ...
                <li class="event-date-entry">
                  <div class="event-calendar-container">
                    <div class="event-calendar">
                      <div class="event-calendar-month">May</div>
                      <div class="event-calendar-date">3</div>
                      <div class="event-calendar-day">Friday</div>
                    </div>
                  </div>
