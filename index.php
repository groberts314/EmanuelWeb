    ...
    <div class="main-content">
      ...
      <div class="module-container photo-carousel" id="photo-carousel-container">
          ...
          <div class="fluid-width-video-wrapper">
            <iframe class="video-iframe" src="https://www.youtube-nocookie.com/embed/jx6_aaIhyLA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          <p style="margin-top: 22px; text-align: center">
            <strong>Emanuel Online Sunday July 26, 2020</strong><br />
          </p>
      </div>
