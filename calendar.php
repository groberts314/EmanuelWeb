      ...
      <div class="col-xs-12">
        ...
        <p>
          <?php
            ...
            $beginningOfNextMonth = new DateTime('2024-08-01', $pacificTimeZone);

            if ($now > $beginningOfNextMonth) {
              echo <<<HTML
              <a href="./calendars/calendar-2024-08.pdf" target="_blank">August 2024 printer-friendly calendar</a>
HTML;
            } else {
              echo <<<HTML
              <a href="./calendars/calendar-2024-07.pdf" target="_blank">July 2024 printer-friendly calendar</a>
HTML;
            }
          ?>
        </p>
        ...
        <?php
          if ($now > $beginningOfNextMonth) {
            echo <<<HTML
            <img src="images/calendars/calendar-2024-08.jpg" alt="August 2024 Event Calendar" />
HTML;
          } else {
            echo <<<HTML
            <img src="images/calendars/calendar-2024-07.jpg" alt="July 2024 Event Calendar" />
HTML;
          }
        ?>
      </div>
