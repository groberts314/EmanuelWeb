      ...
      <div class="col-xs-12">
        ...
        <p>
          <?php
            ...
            $beginningOfNextMonth = new DateTime('2025-04-01', $pacificTimeZone);

            if ($now > $beginningOfNextMonth) {
              echo <<<HTML
              <a href="./calendars/calendar-2025-04.pdf" target="_blank">April 2025 printer-friendly calendar</a>
HTML;
            } else {
              echo <<<HTML
...
HTML;
        ...
        <?php
          if ($now > $beginningOfNextMonth) {
            echo <<<HTML
            <img src="images/calendars/calendar-2025-04.jpg" alt="April 2025 Event Calendar" />
HTML;
          } else {
            echo <<<HTML
            <img src="images/calendars/calendar-2025-03.jpg" alt="Marcgh 2025 Event Calendar" />
HTML;
          }
        ?>
      </div>
